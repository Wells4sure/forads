				...
				<div class="row">
					<div class="col-md-5 col-md-offset-4">
						<div class="user-form text-center text-success">
							<div class="icon-object2 border-success2 text-success2"><i class="far fa-check-circle fa-5x"></i></div>
							<h3><?php
										echo $successMsg;
	...
	<footer id="footer">
							...
							<ul>
								...
								<li>
									<ul class="list-inline social">
										...
										<li><a class="google" href="#"><i class="fab fa-google-plus-square"></i></a></li>
										<li><a class="instagram" href="#"><i class="fab fa-instagram"></i></a></li>
										<li><a class="youtube" href="#"><i class="fab fa-youtube-play"></i></a></li>
									</ul>
								</li>
							</ul>
						</div>
		...
		<div class="footer-bottom clearfix">
			<div class="container">
				<div class="row">
					<div class="col-sm-6">
						<p>&copy; 2018 forards. Design & Developed by <a href="http://wcalpcafe.com/">WCALPCAFE</a></p>
					</div>
					<div class="col-sm-6">
